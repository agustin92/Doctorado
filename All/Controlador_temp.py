...
#        self.contemp.write('*RST')
    ...
    def set_control_loop(self,loop=1, unit=1,pwup=0, cpwr=1):
        # Fija con que temómetro se fija la temperatura.
        # Por default en este equipo se controla con el termómetro A.
        self.contemp.write('CSET {}, {}, {}, {}, {}'.format(str(loop),self.input,str(unit),str(pwup),str(cpwr)))
