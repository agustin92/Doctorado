...
class Worker2(QRunnable):
    ...
    def run(self):
        ...
        '''
        self.signals.result2.emit(self.res.mean_meas(self.parameters['samples']))
        self.res.stop_meas()
        self.signals.finished.emit()  # Done
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def update(self,data):
        ...
        self.ui.lineEdit_11.setText(self._translate("MainWindow", "{:.5f}".format(str(self.resistance[-1]))))
        self.ui.lineEdit_12.setText(self._translate("MainWindow", "{:.5f}".format(str(self.angle[-1]))))
    ...
    def start(self):
        ...
        self.worker2 = Worker2(self.param)
        self.worker2.signals.result2.connect(self.update)
        self.worker2.signals.finished2.connect(self.end)
